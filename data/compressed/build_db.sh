...
CREATE TABLE dave_data (IPAddress real,DictatorGame real,PrisonersDilemma real,CharitableGiving real,Honesty real,PunishmentOfSelfish real,PunishmentOfFairness real,Impatience_(time_discountin) real,reflectiveness_(correct_answers_on_CRT) real,big5-extraversion real,big5-agreeableness real,big5-conscientiousness real,big5-emotionalstability real,big5-openness real,age real,female real,graduated_from_college,income_over_35k real,passed_comprehension_questions real,risk_appetite real,trust real,Support_for_Rep1_vs_Dem7,god real,log10_number_of_studies_completed real);
.import ../hardcoded-dave-data.csv dave_data
...
.import ../zip2popdensity-area.csv popdense
" | sqlite3 data.db
rm ../IP2Zip.csv
rm ../hardcoded-dave-data.csv
rm ../zip2unemployment.csv
rm ../zip2popdensity-area.csv
